...
bash tests/packages.sh         # stones 标准库包回归测试（7/7 通过，十四包双侧）
...
| [10-纯卅标准库包.md](./10-纯卅标准库包.md) | 初学者 | 纯 卅 实现的 stones 十四包（算术/文本/游戏/中文数字/集合运算/统计/单位换算/进制/几何/算法 + v0.2 的数列/逻辑/密码/日期），自举分层与 exe 内嵌说明 |
